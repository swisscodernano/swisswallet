...
public class GetInfoCircuitStatusReplyTests
{
	...
	public async Task ParseReplyAsync()
	{
		...
		// Circuit #5.
		{
			...
			Assert.Equal("rhuvjl2kosdi3xgnmkr4bwnvpmlsvupajkubuazxendgtorvi2q4nhyd", circuitInfo.RendQuery);
