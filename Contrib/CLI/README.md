...
A bash script for effortless interaction with the SwissWallet RPC Server.
...
```
The supported RPC commands are listed in the [documentation](https://github.com/swisscodernano/swisswallet/blob/master/docs/RPC.md).
