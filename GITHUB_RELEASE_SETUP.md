...
./Contrib/release-automation.sh 2.0.0

# 3. Monitor GitHub Actions
# Visit: https://github.com/swisssecurity/swisswallet/actions

# 4. Verify release
./Contrib/verify-release.sh v2.0.0

# 5. Announce release
echo "🎉 SwissWallet v2.0.0 released with Swiss security!"
```
...
./Contrib/release-automation.sh 2.0.1
```
